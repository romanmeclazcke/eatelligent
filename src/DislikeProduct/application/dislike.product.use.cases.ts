...
export class dislikeProductUseCases{
    constructor(private dislikeProductRepository:dislikeProductRepositorySequelize,private userRepository:userRepositorySequelize, private productRepository: productRepositorySequelize){}


    async getDislikeProduct(userId:string):Promise<Result<dislikeProductEntity[]>>{
        ...
        const dislikeProduct= await this.dislikeProductRepository.getDislikeProduct(userId);
    ...
    async addDislikeProduct(userId:string,productId:string):Promise<Result<dislikeProductEntity>>{
        const user = await this.userRepository.getUserById(userId);
    ...
    async deleteDislikeProduct(userId:string,productId:string):Promise<Result<string>>{
        const user = await this.userRepository.getUserById(userId);
        ...
        const dislikeProductDeleted= await this.dislikeProductRepository.deleteDislikeProduct(userId,productId);
